 ...
 * @subpackage As_Wp_Admin_Customization/admin
 */
 ...
 */
class As_Wp_Admin_Customization_Admin {
	...
	public function enqueue_styles() {
		...
		wp_enqueue_style( $this->as_wp_admin_customization, plugin_dir_url( __FILE__ ) . 'css/as-wp-admin-customization-admin.css', array(), $this->version, 'all' );
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( $this->as_wp_admin_customization, plugin_dir_url( __FILE__ ) . 'js/as-wp-admin-customization-admin.js', array( 'jquery' ), $this->version, false );
