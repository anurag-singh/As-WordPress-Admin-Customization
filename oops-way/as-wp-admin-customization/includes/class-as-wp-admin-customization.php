 ...
 * @subpackage As_Wp_Admin_Customization/includes
 */
 ...
 */
class As_Wp_Admin_Customization {
	 ...
	 * - As_Wp_Admin_Customization_Admin. Defines all hooks for the admin area.
	...
	private function define_admin_hooks() {
		...
		$plugin_admin = new As_Wp_Admin_Customization_Admin( $this->get_as_wp_admin_customization(), $this->get_version() );
