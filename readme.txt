...
Installing "Admin Customization" can be done either by searching for "Admin Customization" via the "Plugins > Add New" screen in your WordPress dashboard, or by using the following steps:
